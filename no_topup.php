...
<html lang="en">
  ...
  <body>
    ...
    <?php if(isset($_GET['error'])): ?>
      <div style="width: 100vw !important; text-align: center; background-color: #E9594D !important;" class="text-xs py-1 px-1 text-white">
        <?= $_GET['error'] ?>
      </div>
    <?php elseif(isset($_GET['response'])): ?>
      <div style="width: 100vw !important; text-align: center; background-color: #87C47F !important;" class="text-xs py-1 px-1 text-white">
        <?= $_GET['response'] ?>
      </div>
    <?php endif; ?>
              ...
              <div class="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                  ...
                  <form action="backend\app\account.php" method="post">
                    ...
                    <div class="flex items-center justify-start w-full">
                        <button type="submit" name="save_no_topup" class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 transition duration-150 ease-in-out hover:bg-indigo-600 bg-indigo-700 rounded text-white px-8 py-2 text-sm">Save</button>
    ...
    <div class="antialiased bg-gray-100 dark-mode:bg-gray-900 border">
        <div class="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
          <div x-data="{ open: true }" class="flex flex-col max-w-screen-xl px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
            ...
            <nav :class="{'flex': open, 'hidden': !open}" class="flex-col flex-grow hidden pb-4 md:pb-0 md:flex md:justify-end md:flex-row">
              <a href="index.html" class="px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 focus:text-gray-900 bg-indigo-500 text-white focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">No TopUp</a>
              <a href="topup.html" class="px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline" href="#">TopUp</a>
            </nav>
          </div>
        </div>
      </div>
        ...
        <div class="sm:px-6 w-full">
          <div class="px-4 md:px-10 py-4 md:py-7">
            <div class="flex items-center justify-between pl-4">
              ...
              >
                List Account <span class="bg-indigo-300 text-xs py-1 px-1 text-white rounded-lg">No TopUp</span>
              </p>
              <button 
      ...
      <script src="src/js/no-topup.js"></script>
    </div>
  </body>
</html>
